...
<head>
  ...
  <!-- Page Title -->
  <title>Tiara Lace Top | MEQA.MY</title>
</head>
            ...
            <div class="container-fluid">
                <nav class="m-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                      ...
                      <li class="breadcrumb-item  breadcrumb-light active" aria-current="page">Tiara Lace Top</li>
                    </ol>
                </nav>            </div>
        </div>
        <!-- / Breadcrumbs-->
            ...
            <div class="row g-9" data-sticky-container>
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="row g-3" data-aos="fade-right">
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable src="./assets/images/products/meqaTiaraLaceTop.png">
                            </picture>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="sticky-top top-5">
                        <div class="pb-3" data-aos="fade-in">
                            ...
                            <h1 class="mb-1 fs-2 fw-bold">Tiara Lace Top</h1>
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="fs-4 m-0">RM89</p>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-4 d-flex justify-content-start flex-wrap align-items-start">
                                    <picture class="me-2">
                                        <img class="f-w-24 p-2 bg-light border-bottom border-dark border-2 cursor-pointer" src="./assets/images/products/meqaTiaraLaceTop.png">
                                    </picture>
                                </div>
                            </div>
                                ...
                                <div class="accordion-item">
                                  ...
                                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionProduct">
                                    <div class="accordion-body">
                                        <p class="m-0">Measurement : 
                                            <br>- shoulder 16/42cm
                                            <br>- chest: 18.5/47.5cm
                                            <br>- length : 23/58cm
                                            <br>- armhole: 19/48cm
                                            <br>- waist: 34/87cm
                                            <br><br>- Material : High quality Lace
                                            <br>- Tak jarang & selesa
