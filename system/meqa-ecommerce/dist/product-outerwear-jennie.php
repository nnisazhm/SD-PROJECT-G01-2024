            ...
            <div class="container-fluid">
                <nav class="m-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                      ...
                      <li class="breadcrumb-item  breadcrumb-light active" aria-current="page">Jennie Denim Hoodie</li>
                    </ol>
                </nav>            
            </div>
        </div>
            ...
            <div class="row g-9" data-sticky-container>
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="row g-3" data-aos="fade-right">
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable src="./assets/images/products/meqaJennieDenimTop.png">
                            </picture>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="sticky-top top-5">
                        <div class="pb-3" data-aos="fade-in">
                            ...
                            <h1 class="mb-1 fs-2 fw-bold">Jennie Denim Hoodie</h1>
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="fs-4 m-0">RM109</p>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-4 d-flex justify-content-start flex-wrap align-items-start">
                                    <picture class="me-2">
                                        <img class="f-w-24 p-2 bg-light border-bottom border-dark border-2 cursor-pointer" src="./assets/images/products/meqaJennieDenimTop.png">
                                    </picture>
                                </div>
                            </div>
                                ...
                                <div class="accordion-item">
                                  ...
                                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionProduct">
                                    <div class="accordion-body">
                                        <p class="m-0">Jennie Denim & Cotton Hoodie
                                            <br>- Quality : High quality unique & rare piece !
                                            <br>- Limited edition , only in MEQA
                                            <br>- Type : Hoodie with button & long sleeves
                                            <br><br>Measurement :
                                            <br>- Chest up till 43
                                            <br>- Length 24.5
                                        </p>
