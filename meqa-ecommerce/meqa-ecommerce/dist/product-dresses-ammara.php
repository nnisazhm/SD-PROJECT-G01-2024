...
<head>
  ...
  <!-- Page Title -->
  <title>Ammara Dress | MEQA.MY</title>
</head>
            ...
            <div class="container-fluid">
                <nav class="m-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                      ...
                      <li class="breadcrumb-item breadcrumb-light"><a href="category-dresses.html">Dresses</a></li>
                      <li class="breadcrumb-item  breadcrumb-light active" aria-current="page">Ammara Dress</li>
                    </ol>
                </nav>            
            </div>
        </div>
            ...
            <div class="row g-9" data-sticky-container>
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="row g-3" data-aos="fade-right">
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable src="./assets/images/products/meqaAmmaraDress.png">
                            </picture>
                        </div>
                    ...
                    <div class="sticky-top top-5">
                        <div class="pb-3" data-aos="fade-in">
                            <div class="d-flex align-items-center mb-3">
                                <p class="small fw-bolder text-uppercase tracking-wider text-muted m-0 me-4">Dresses</p>
                            </div>
                            
                            <h1 class="mb-1 fs-2 fw-bold">Ammara Dress</h1>
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="fs-4 m-0">RM79</p>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-4 d-flex justify-content-start flex-wrap align-items-start">
                                    <picture class="me-2">
                                        <img class="f-w-24 p-2 bg-light border-bottom border-dark border-2 cursor-pointer" src="./assets/images/products/meqaAmmaraDress.png">
                                    </picture>
                                </div>
                            </div>
                                ...
                                <div class="accordion-item">
                                  ...
                                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionProduct">
                                    <div class="accordion-body">
                                        <p class="m-0">Material: Soft Cotton 
                                            <br>- Full Front Button
                                            <br>- Ruffle below hem
                                            <br>- Stretchable sleeve hem (wudhu friendly)
                                            <br>- Free embroidery belt
                                            <br>- Suitable for pregnant mothers & BF moms too!
                                            <br>- Material best & sejuk, tak jarang, tak panas 
                                            <br><br>Measurement :
                                            <br>- Shoulder: 39cm - 41cm
                                            <br>- Chest: 92cm - 107cm
                                            <br>- Length: 142cm
                                            <br>- Sleeve : 61cm
                                            <br>- Armhole (flat) : 26cm
                                            <br>- Waist: 117cm
                                            <br>- Flare: up to 75"
                                        </p>
                                    </div>
