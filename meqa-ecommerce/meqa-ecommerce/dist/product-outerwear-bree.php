...
<head>
  ...
  <!-- Page Title -->
  <title>Bree Knitted Cardigan | MEQA.MY</title>
</head>
            ...
            <div class="container-fluid">
                <nav class="m-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                      ...
                      <li class="breadcrumb-item breadcrumb-light"><a href="category-outerwear.html">Outerwear</a></li>
                      <li class="breadcrumb-item  breadcrumb-light active" aria-current="page">Bree Knitted Cardigan</li>
                    </ol>
                </nav>            
            </div>
        </div>
            ...
            <div class="row g-9" data-sticky-container>
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="row g-3" data-aos="fade-right">
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable src="./assets/images/products/meqaBreeCardiganOuterwear.png">
                            </picture>
                        </div>
                    ...
                    <div class="sticky-top top-5">
                        <div class="pb-3" data-aos="fade-in">
                            <div class="d-flex align-items-center mb-3">
                                <p class="small fw-bolder text-uppercase tracking-wider text-muted m-0 me-4">Outerwear</p>
                            </div>
                            
                            <h1 class="mb-1 fs-2 fw-bold">Bree Knitted Cardigan</h1>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-4 d-flex justify-content-start flex-wrap align-items-start">
                                    <picture class="me-2">
                                        <img class="f-w-24 p-2 bg-light border-bottom border-dark border-2 cursor-pointer" src="./assets/images/products/meqaBreeCardiganOuterwear.png">
                                    </picture>
                                </div>
                            </div>
                                ...
                                <div class="accordion-item">
                                  ...
                                  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionProduct">
                                    <div class="accordion-body">
                                        <p class="m-0">Bree Striped Cardigan is now back in stock ! 
                                            <br>- Very pretty, bigger cutting, stylish & HIGH QUALITY
                                            <br>- High quality soft knit, stretchy
                                            <br>- Suitable for indoor & Outdoor
                                            <br>- Buttons down with gold buttons
                                            <br>- breastfeeding friendly
                                            <br><br>Measurement :
                                            <br>- length 24.5
                                            <br>- chest 49
                                            <br>- sleeves 27 
