                ...
                <div id="viewStaff">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            // Check and display the staff data
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>
                                            <a href='editStaff.php?id=" . $row['staff_id'] . "' class='btn btn-warning btn-sm'>Edit</a>
                                            <a href='deleteStaff.php?id=" . $row['staff_id'] . "' class='btn btn-danger btn-sm' onclick='return confirmDelete()'>Delete</a>
                                          </td>";
                                    echo "</tr>";
                                }
                            } else {
