...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <!--<h2 class="mt-4 text-center">Staff - Customer Dashboard</h2>-->
    <div id="viewStaff">
    ...
    <table class="table table-striped table-hover table-bordered">
        ...
        <tbody>
            <?php
                ...
                $sql = "SELECT * FROM customer"; // Ensure this table name is correct
                ...
                if ($result->num_rows > 0) {
                    ...
                    // If no data found
                    echo "<tr><td colspan='6'>No customer data found</td></tr>";
                }
