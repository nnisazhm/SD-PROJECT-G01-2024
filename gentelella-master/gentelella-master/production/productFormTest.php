...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $product_sku = $_POST['product_sku'] ?? ''; // Fixed the name from 'SKU' to 'product_sku'
    $product_quantity = $_POST['product_quantity'] ?? ''; // Fixed the name from 'QTY' to 'product_quantity'
